"""
SmartMonitorPlugin 单元测试
"""
import pytest
from unittest.mock import Mock, AsyncMock
from plugins.monitor.smart_monitor_plugin import SmartMonitorPlugin

class TestSmartMonitorPlugin:
    def setup_method(self):
        self.mock_client = Mock()
        self.mock_config = {'dummy': 'value'}
        self.plugin = SmartMonitorPlugin(self.mock_client, self.mock_config)
