        ...
        if hasattr(ui_config, 'FORWARD'):
            ...
            if hasattr(forward, 'forward_channel_pairs'):
                ...
                for pair in forward.forward_channel_pairs:
                    ...
                    # 添加其他过滤选项到每个频道对配置中
                    for filter_field in ["exclude_forwards", "exclude_replies", "exclude_text", "exclude_links", "remove_captions", "hide_author", "send_final_message", "enabled", "enable_web_page_preview"]:
