...
- **同义关键词支持**: 新增了普通下载中的同义关键词功能
  - 支持使用横杠"-"连接多个同义词，例如 "关键词 1-关键词 2-关键词 3"
  - 任意一个同义词匹配即触发整个关键词组的下载
  - 下载目录使用完整的同义词组作为目录名称
  - 界面中同义关键词组显示为完整格式 (关键词：关键词 1-关键词 2-关键词 3)

### 改进

- **关键词匹配逻辑**: 优化了关键词匹配机制，支持更灵活的关键词组合
- **界面提示**: 更新了关键词输入框的提示信息，明确说明同义关键词的使用方法
- **日志输出**: 增加了同义关键词匹配的详细日志记录，便于用户调试和跟踪
